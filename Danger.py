...
def create_two_button_markup():
    ...
    # Define two buttons
    button1 = types.InlineKeyboardButton("🔥 Join Our Channel 🔥", url="https://t.me/drabhacks")
    button2 = types.InlineKeyboardButton("☣️ Contact Owner ☣️", url="t.me/drabbyt")
...
UPI_ID = "ouxaid7@oksbi"  # Replace with your UPI ID
PAYEE_NAME = "SHAKIR"  # Replace with the payee's name
...
def send_qr_image(chat_id, img, amount):
    with BytesIO() as output:
        ...
        output.seek(0)
        bot.send_photo(chat_id, output, caption=f"Here is your UPI QR code for ₹{amount} payment After Pay Send Your Transaction Id With Screenshot To My Owner @drabbyt")
