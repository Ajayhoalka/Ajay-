...
def handle_attack_command(message):
    ...
    # Skip the cooldown and proceed with the new attack
    bot.attack_in_progress = False  # Reset the status, or adjust based on logic
    bot.perform_attack()  # Add your attack logic here
else:
    bot.perform_attack()  # Add your attack logic here
